...
invisibleball=createSprite(330, 230, 10, 15);
invisibleball.visible=false;
ballGroup.add(invisibleball);
...
if(keyDown("right")){
  ...
  if(ballGroup.isTouching(spaceCraft)){
    hasDocked=true;
    textSize(20);
    fill("white");
text("Docking Successful!", 300, 380);
}
